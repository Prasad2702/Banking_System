...
<head>
  ...
  <link rel="shortcut icon" href="images/bank3.png" type="image/x-icon">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">
        ...
        <img src="images/bank3.png" alt="logo" style="width:40px;">
      </a>
  ...
  <section class="topContent">
    <div class="mainHeading">
      ...
      <div style="margin-top: 12px;">
        <span class="sub-content">Welcome To The Spark Bank</span>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/Bank_1.webp" alt="Spark Bank">
        </div>
  ...
  <footer>
    ...
    <p class="text-copy">
       &copy; This Project Is Done By Prasad
    </p>
  </footer>
  <!-- End Footer -->
